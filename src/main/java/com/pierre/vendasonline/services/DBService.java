...
import com.pierre.vendasonline.domain.Produto;
...
public class DBService {
	...
	public void instantiateTestDatabase () throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "pierre28.enoc@gmail.com", 
				"36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		

		Cliente cli2 = new Cliente(null, "Ana Silva", "pierre.enoc@gmail.com", 
				"94233331097", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("119363323", "11538393"));
		

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c3);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida paulista", "1015", "Sala 900", "Centro", "001777012", cli2, c2);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("01/09/2020 21:48"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("30/08/2020 22:48"), cli1, e2);
